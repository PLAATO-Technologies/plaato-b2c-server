...
public class Device implements Target {
    ...
    @JsonView(View.Private.class)
    public PlaatoStructure plaato = new PlaatoStructure();
    ...
    private static final long offlinePeriod = TimeUnit.MINUTES.toMillis(7);
    public boolean isOfflineFor7Minutes(long now) {
        return connectTime <= disconnectTime && connectTime + offlinePeriod < now;
    }
